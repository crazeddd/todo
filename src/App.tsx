...
const App: Component = () => {
  const { createItem, removeItem, removeAllItems, getItems, items } = handleTodo();
  ...
  return (
    <>
      <div class="wrapper secondary gp-2">
        <div class="row nav center">
          ...
          <div class="button-wrapper row">
            ...
            <button class="primary circle" onclick={() => removeAllItems()}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 96C0 78.3 14.3 64 32 64l384 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 128C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32l384 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 288c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32L32 448c-17.7 0-32-14.3-32-32s14.3-32 32-32l384 0c17.7 0 32 14.3 32 32z" /></svg></button>
          </div>
        </div>
      ...
      {isOpen() && <div class="modal secondary column gp-3">
        ...
        ></input>
        <button class="primary" onclick={() => { createItem(name(), new Date(date())) instanceof Error ? console.error("Provide a date & name") : setIsOpen(false) }}>Create</button>
      </div>}
    </>
  );
};
